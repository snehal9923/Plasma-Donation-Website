...
<nav id="mainNav" class="navbar fixed-top navbar-default navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="./index.php">DONATEPLASMA</a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <ul class="navbar-nav form-inline my-2 my-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" href="map.php">Map to donate</a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        Donor name<?php if(isset($_SESSION['name'])) echo $_SESSION['name']; ?><!-- Donor Name -->
        </a>
